...
import { fetchVideos } from "../redux/features/videos/videoThunks"; // Updated import for videos
...
const Decoding = () => {
  ...
  const videosState = useSelector((state) => state.videos.Videos); // Updated for videos
  ...
  const videosForTable = videosState.map((video) => ({
